...
emojione.imagePathPNG = siteurl + 'app/plugins/smiley/assets/png/';
emojione.imagePathSVG = siteurl + 'app/plugins/smiley/assets/svg/';
...
function chatWith(chatuser,chatheaderimg,status) {
    // siteurl = getAbsolutePath();
    console.log('adsf', siteurl);
...
function createChatBox(chatboxtitle,chatheaderimg,status,minimizeChatBox) {
    ...
    $("<div />" ).attr("id","chatbox_"+chatboxtitle)
        ...
        .html('<div class="chatbox-icon" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')" href="javascript:void(0)"><div class="contact-floating red"><img class="chat-image img-circle pull-left" src="' + siteurl + 'storage/user_image/'+chatheaderimg+'"><small class="unread-msg">2</small><small class="status Online"></small></div></div>' +
        '<div class="panel personal-chat"> ' +
        '<div class="panel-heading chatboxhead"> ' +
        '<div class="panel-title">' +
        '<img class="chat-image img-circle pull-left" height="36" width="36" src="' + siteurl + 'storage/user_image/'+chatheaderimg+'" alt="avatar-image"> ' +
        '<div class="header-elements">' +
        '<a href="' + siteurl + 'profile.php?uname='+chatboxtitle+'">'+chatboxtitle+'</a>' +
        '</h3>' +
        '<br> ' +
...
function uploadimage(touname) {
    ...
    var base_url = siteurl +  'process.php?tun='+tun+'&fun='+fun;
...
$(document).on('click', ".uploadFile", function (e){
    ...
    $(function() {
        ...
        $('#uploader_'+touname).plupload({
            ...
            // Flash settings
            flash_swf_url : siteurl + 'plugins/uploader/Moxie.swf',

            // Silverlight settings
            silverlight_xap_url : siteurl + 'plugins/uploader/Moxie.xap',
